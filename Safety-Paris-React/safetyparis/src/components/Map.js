  ...
  return (
    <div className="map-container">
      <div className="top-banner">
        ...
        {/* 도움 지원 버튼 추가 */}
        <a href="https://www.notion.so/2f329a3f820248bdb639936d65c9ce43" target="_blank" rel="noopener noreferrer" className="help-btn">
          도움 지원
        </a>
      </div>
      <div id="map"></div>
      ...
      {isFormOpen && (
        <div className="overlay">
          <div className="central-form">
            ...
            <button className="close-btn" onClick={closeForm}>닫기</button>
          </div>
          </div>
        </div>
      )}
